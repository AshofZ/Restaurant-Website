                ...
                <>
                    ...
                    <div className="row">
                        <div className="col-md-8">
                            <table className="table">
                                ...
                                <tbody>
                                    {cart.map(product => (
                                        <tr key={product._id}>
                                            <td><img style={{ maxWidth: '110px' }} className="img-fluid w-100 img-thumbnail" src={`/uploads/${product.fileName}`} alt='product' /></td>
                                            <td>
                                                <Link
                                                    to={`/product/${product._id}`}
                                                    type='button'>{product.productName}</Link>
                                            </td>
                                            ...
                                            <td>
                                                <input type="number" name="" id="" min='1' max={product.productQty} value={product.count} onChange={e => handleQtyChange(e, product)} />
                                            </td>
                                            <td><button type="button" className="btn btn-danger btn-sm" onClick={() => dispatch(deleteFromCart(product))}>
                        ...
                        <div className="col-md-4">
                            ...
                            <p className="font-weight-bold">Total: ${cart.reduce((currentSum, currentCartItem) => currentSum + currentCartItem.count * currentCartItem.productPrice, 0).toFixed(2)}</p>
