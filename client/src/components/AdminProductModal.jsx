                                ...
                                loading ? (
                                    ...
                                    <>
                                        <div className="custom-file mb-2">
                                            <input type="file" name="productImage" id="" onChange={handleProductImage} className="custom-file-input" />
                                            <label htmlFor="" className="custom-file-label">Choose File</label>
                                        </div>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <textarea name="productDesc" value={productDesc} onChange={handleProductChange} className="form-control" rows="3"></textarea>
                                        </div>
                                        ...
                                        <div className="form-row">
                                            <div className="form-group col-md-6">
                                                ...
                                                <select className="form-control mr-sm-2" name="productCategory" onChange={handleProductChange}>
                                            ...
                                            <div className="form-group col-md-6">
                                                ...
                                                <input className="form-control" type="number" name="productQty" value={productQty} onChange={handleProductChange} min="0" max="1000" />
                                            </div>
                                        </div>
                                    </>
                                )
